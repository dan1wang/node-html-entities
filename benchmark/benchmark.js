...
benchmark('Decode test', {
    ...
    'newDecoder.decodeHTML4Entities': function () { newDecoder.decodeHTML4Entities(textToDecode, true, false); },
    'newDecoder.decodeHTML5Entities': function () { newDecoder.decodeHTML5Entities(textToDecode, true, false); },
    'newDecoder.decodeHTML4EntitiesStrict': function () { newDecoder.decodeHTML4EntitiesStrict(textToDecode); },
    'newDecoder.decodeHTML5EntitiesStrict': function () { newDecoder.decodeHTML5EntitiesStrict(textToDecode); }
});
