...
var decodeHTML4Entities = function(input, strict) {
...
var decodeHTML5Entities = function(input, strict) {
    if (!input || !input.length) return '';
    var segments = input.split('&');
    if (segments.length == 1) return input;
    var output = '';
    ...
    for (i=1; i<segments.length; i++) {
        ...
        if (seg.charAt(1) == '#') {
            ...
            } else if (candidateStr.length == 10) {
            ...
            } else if (candidateStr.length == 11) {
            ...
            } else if (candidateStr.length == 12) {
            ...
            } else if (candidateStr.length == 13) {
            ...
            } else if (candidateStr.length == 14) {
            ...
            } else if (candidateStr.length == 15) {
            ...
            } else if (candidateStr.length == 16) {
            ...
            } else if (candidateStr.length == 17) {
            ...
            } else if (candidateStr.length == 18) {
            ...
            } else if (candidateStr.length == 19) {
            ...
            } else if (candidateStr.length == 20) {
            ...
            } else if (candidateStr.length == 21) {
            ...
            } else if (candidateStr.length == 22) {
            ...
            } else if (candidateStr.length == 23) {
            ...
            } else if (candidateStr.length == 24) {
            ...
            } else if (candidateStr.length == 25) {
                if (candidateStr == "NotNestedGreaterGreater") {
                    output += "\u2AA2\u0338" + seg.substring(26);
                    continue;
                }
            } else if (candidateStr.length == 26) {
                if (candidateStr == "ClockwiseContourIntegral") {
                    output += "\u2232" + seg.substring(27);
                    continue;
                } else if (candidateStr == "DoubleLongLeftRightArrow") {
                    output += "\u27FA" + seg.substring(27);
                    continue;
                }
            } else if (candidateStr.length == 33) {
                if (candidateStr == "CounterClockwiseContourIntegral") {
                    output += "\u2233" + seg.substring(34);
                    continue;
                }
            }
            if (strict != true) {
