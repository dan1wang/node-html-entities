...
var decodeHTML4Entities = function(input, semiRequired, allowAllCap) {
    ...
    while (i < len) {
        ...
        if (char == '&') {
            if (i + 8 < len) {
                trailingSemiColon = input.charAt(i+9) == ';';
            ...
            if (i + 7 < len) {
                trailingSemiColon = input.charAt(i+8) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 6 < len) {
                trailingSemiColon = input.charAt(i+7) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 5 < len) {
                trailingSemiColon = input.charAt(i+6) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 4 < len) {
                trailingSemiColon = input.charAt(i+5) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 3 < len) {
                trailingSemiColon = input.charAt(i+4) == ';';
                if (!semiRequired || trailingSemiColon) {
...
var decodeHTML5Entities = function(input, semiRequired, allowAllCap) {
    ...
    while (i < len) {
        ...
        if (char == '&') {
            if (i + 9 < len) {
                trailingSemiColon = input.charAt(i+10) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 33 < len) {
                trailingSemiColon = input.charAt(i+34) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 25 < len) {
                trailingSemiColon = input.charAt(i+26) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 23 < len) {
                trailingSemiColon = input.charAt(i+24) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 22 < len) {
                trailingSemiColon = input.charAt(i+23) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 21 < len) {
                trailingSemiColon = input.charAt(i+22) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 20 < len) {
                trailingSemiColon = input.charAt(i+21) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 19 < len) {
                trailingSemiColon = input.charAt(i+20) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 18 < len) {
                trailingSemiColon = input.charAt(i+19) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 17 < len) {
                trailingSemiColon = input.charAt(i+18) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 16 < len) {
                trailingSemiColon = input.charAt(i+17) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 15 < len) {
                trailingSemiColon = input.charAt(i+16) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 14 < len) {
                trailingSemiColon = input.charAt(i+15) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 13 < len) {
                trailingSemiColon = input.charAt(i+14) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 12 < len) {
                trailingSemiColon = input.charAt(i+13) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 11 < len) {
                trailingSemiColon = input.charAt(i+12) == ';';
                if (!semiRequired || trailingSemiColon) {
            ...
            if (i + 10 < len) {
                trailingSemiColon = input.charAt(i+11) == ';';
                if (!semiRequired || trailingSemiColon) {
